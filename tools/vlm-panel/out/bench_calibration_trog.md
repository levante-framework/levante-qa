...
Generated: 2026-08-06T06:54:59.241Z
...
## In-sample fit
- Diag target (n=99): MAE cal **0.063** / raw **0.104**; Spearman cal **0.676** / raw **0.637**
- Bench trials target (n=99): MAE cal **0.063** / raw **0.104**; Spearman cal **0.690** / raw **0.636**

## Held-out CV
- Diag target (5, n=99): MAE cal **0.077** / raw **0.104**; Spearman cal **0.593** / raw **0.637**; bias 0.003
- Bench trials target (5, n=99): MAE cal **0.077** / raw **0.104**; Spearman cal **0.593** / raw **0.636**; bias 0.003

## Cross-check on dual-matched items
- MAE(pred_diag, p_diag): **0.063**
- MAE(pred_bench, p_bench): **0.063**
- MAE(pred_bench, p_diag): **0.063** (bench model vs diag labels)
