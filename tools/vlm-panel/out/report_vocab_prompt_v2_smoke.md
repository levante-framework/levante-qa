...
Generated: 2026-08-10T00:16:15.337Z
...
- Spread: min 0.78, median 0.94, max 0.99, SD 0.07 -> INADEQUATE

### Screen flags
- BROKEN (below chance): **2** | HARD: **25** | CEILING: **125** | OK: 18
- Review list: `out/review_vocab_en.csv` | full screen: `out/screen_vocab_en.csv`

### Validation vs human labels (matched items)
- Spearman rho difficulty (p_vlm vs human p_correct), n=162: **0.537**
- Spearman rho discrimination (rpb_vlm vs human point_biserial), n=43: **-0.117**
- BROKEN catch: of 5 human below-chance item(s), VLM flagged **2** as BROKEN/HARD
- BROKEN/HARD precision: of 27 VLM-flagged item(s), **6** are human-hard (p_correct < 0.5)
...
- In-sample (n=162): MAE calibrated **0.116** vs raw **0.187**; Spearman calibrated **0.537** vs raw **0.537**
- Held-out CV (5, n=162): MAE calibrated **0.123** vs raw **0.187**; bias 0.001
- Held-out CV Spearman: calibrated **0.391** vs raw **0.537**
